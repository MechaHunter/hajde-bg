import { Listing, Seller, SearchSuggestion } from "./types";
...
export const listings: Listing[] = [
  ...
  {
    id: "2", title: "BMW 320d, 2020, автоматик, LED", description: "BMW 320d в отлично състояние. Сервизна история, нови гуми. Без забележки по купето.", price: 38500, currency: "EUR", category: "vehicles", subcategory: "cars",
  ...
  {
    id: "3", title: "iPhone 15 Pro Max 256GB - нов", description: "Чисто нов iPhone 15 Pro Max, неразопакован, с гаранция 2 години. Цвят Natural Titanium.", price: 2399, currency: "BGN", category: "electronics", subcategory: "phones",
  ...
  {
    id: "4", title: "Уеб разработка - Изграждане на сайтове", description: "Професионално изграждане на уеб сайтове и онлайн магазини. React, Next.js, WordPress. Бързо и качествено.", price: 1500, currency: "BGN", category: "services",
  ...
  {
    id: "5", title: "Ъглов диван, италианска кожа", description: "Луксозен ъглов диван от естествена италианска кожа. Разтегателен, с ракла за съхранение. Размери: 280x200 см.", price: 3200, currency: "BGN", category: "home-garden", subcategory: "furniture",
  ...
  {
    id: "6", title: "Дамска чанта Louis Vuitton Neverfull", description: "Оригинална Louis Vuitton Neverfull MM. С оригинална кутия и документи. Перфектно състояние.", price: 1850, currency: "EUR", category: "fashion",
  ...
  {
    id: "7", title: "Търси се Front-End Developer (React)", description: "Търсим опитен React developer за нашия екип. Работа от вкъщи, конкурентно заплащане, млад и амбициозен екип.", price: 5000, currency: "BGN", category: "jobs",
  ...
  {
    id: "8", title: "Нощувки в Банско - апартамент до лифта", description: "Уютен апартамент за 4 души на 100м от лифта. С WiFi, паркинг, ски гардероб. Перфектен за зимна ваканция.", price: 120, currency: "BGN", category: "tourism",
  ...
  {
    id: "9", title: "Златен ретривър - кученца с документи", description: "Предлагаме прекрасни кученца Златен ретривър с пълни документи, ваксини и микрочип. Родители шампиони.", price: 1200, currency: "BGN", category: "pets",
  ...
  {
    id: "10", title: "Велоергометър Kettler - нов", description: "Нов велоергометър Kettler с LCD дисплей, 16 програми, пулсомер. Перфектен за домашни тренировки.", price: 450, currency: "BGN", category: "sports",
  ...
  {
    id: "11", title: "Двустаен апартамент под наем - Младост 1", description: "Обзаведен двустаен апартамент до метростанция. Включени ТЕЦ, интернет. Свободен от 01.04.", price: 850, currency: "EUR", category: "real-estate-rent",
  ...
  {
    id: "12", title: "MacBook Pro 14\" M3 Pro - като нов", description: "MacBook Pro 14 инча, M3 Pro чип, 18GB RAM, 512GB SSD. Използван 3 месеца, с гаранция до 2026г.", price: 3800, currency: "BGN", category: "electronics",
...
export const trendingSearches: SearchSuggestion[] = [
  { text: "апартамент София", category: "real-estate-sale", count: 12450 },
  { text: "iPhone 15", category: "electronics", count: 8920 },
  { text: "BMW", category: "vehicles", count: 6780 },
  { text: "работа от вкъщи", category: "jobs", count: 5430 },
  { text: "диван", category: "home-garden", count: 3210 },
  { text: "нощувки Банско", category: "tourism", count: 2890 },
  { text: "велосипед", category: "sports", count: 1560 },
  { text: "куче", category: "pets", count: 1230 },
];

export const cities = [
  "София", "Пловдив", "Варна", "Бургас", "Русе", "Стара Загора", "Плевен",
  "Добрич", "Сливен", "Шумен", "Перник", "Хасково", "Ямбол", "Пазарджик",
  "Благоевград", "Велико Търново", "Враца", "Габрово", "Кърджали", "Банско",
];
